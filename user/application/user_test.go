...
func (suite *TestSuite) TestRefreshTokenSuccess() {
	...
	suite.mockTransactionManager.On("Transaction", mock.AnythingOfType("func(transaction.Transaction) error")).Return(func(fc func(persistent.Transaction) error) error {
		return fc(nil)
	})
