...
import "api-your-accounts/shared/infrastructure/gorm/model"
...
type Budget struct {
	...
	BudgetAvailableBalance []BudgetAvailableBalance `gorm:"foreignKey:BudgetId"`
	BudgetBill             []BudgetBill             `gorm:"foreignKey:BudgetId"`
}
...
type CategoryBill struct {
	...
	BudgetBill []BudgetBill `gorm:"foreignKey:CategoryId"`
}
...
type BudgetBill struct {
	...
	BudgetBillTransaction []BudgetBillTransaction `gorm:"foreignKey:BudgetBillId"`
	BudgetBillShared      []BudgetBillShared      `gorm:"foreignKey:BudgetBillId"`
}
